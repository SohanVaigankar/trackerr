...
const Card = ({ data }) => {
  ...
  return (
    <div
      className="bg-[#1823fb5c] text-primary-font  rounded-xl cursor-pointer shadow-lg hover:scale-[1.015] overflow-hidden md:max-w-[20rem] min-h-[8rem] broder-solid border-2 border-[#00000034] hover:bg-[#1823fb70]"
